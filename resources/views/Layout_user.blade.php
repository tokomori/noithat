...
<body class="cms-index-index cms-home-page">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-6 col-lg-6 pull-left">
                            ...
                            <div class="welcome-msg">Nội Thất Thăng Long</div>
                        </div>
                        <!-- Header Top Links -->
                                    ...
                                    <div class="login">
                                        ...
                                        @else
                                            <a href="{{ route('logout.index') }}">
                                                <span class="hidden-xs">Đăng xuát</span>
                                            </a>
                                        @endif
                                    </div>
                                </div>
    ...
    <a title="Linea HTML Template" href="{{ route('home') }}">
        <img alt="Linea HTML" src="{{ asset('frontend/images/logo-1.png') }}" style="max-width: 50px; height: auto; ">
    </a>
</div>
                        <!-- End Header Logo -->
            ...
            <nav class="hidden-xs">
                <div class="nav-container">
                        ...
                        <div class="mega-container visible-lg visible-md visible-sm">
                            <div class="navleft-container">
                                ...
                                <div class="mega-menu-category" id="mega-menu-category" style="{{ $url_canonical == route('home') || $url_canonical == route('cart-address.index') ? '' : 'display: none' }}">
                                    <ul class="nav">
                                        <li class="nosub"><a href="{{ route('home') }}">
                                        ...
                                        @foreach ($all_category as $all_cate)
                                            ...
                                            <li class="{{ count($childrencate) > 0 ? '' : 'nosub' }}">
                                                <a href="{{ route('category-product.show', $all_cate->category_slug) }}">
                                                    <i class="{{ $all_cate->category_icon }}"></i>
                    ...
                    <div class="our-features-box hidden-xs">
                        <div class="features-block">
                            <div class="offer-block d-flex align-items-center">
                                @isset($features)
                                    @foreach ($features as $key => $feature)
                                        <div class="feature-box {{ $key == 0 ? 'first' : '' }}">
                                            <div class="content">
                                                <h3 style="font-size: 14px; margin-right: 10px;">{{ $feature }}</h3>
                                            </div>
                                        </div>
                                        @if (!$loop->last)
                                ...
                                <form>
                                    ...
                                    <h4><span>Bản tin</span></h4>
                                         ...
                                         <input type="text" placeholder="Nhập địa chỉ email của bạn"
                                             ...
                                             tên="email">
                                             <button class="button" title="Đăng ký" type="submit">
                                                Đăng ký
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            ...
                            <h4>Hướng dẫn mua sắm</h4>
                                 <ul class="links">
                                     <li><a href="#" title="Cách mua">Blog</a></li>
                                     <li><a href="#" title="FAQs">Câu hỏi thường gặp</a></li>
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <h4>Cố vấn phong cách</h4>
                                 <ul class="links">
                                     ...
                                     <li><a href="#" title="Coupou">Giảm giá</a></li>
                         ...
                         <div class="col-md-3 col-sm-6">
                             ...
                             <div class="contacts-info">
                                <div class="address-footer">
                                    <i class="add-icon">&nbsp;</i>Đại Học Nguyễn Trãi
                                </div>
                                <div class="phone-footer"><i class="phone-icon">&nbsp;
                                    </i> +(84) 337 129 045
                                </div>
                                <div class="email-footer"><i class="email-icon">&nbsp;</i>
                                    <a href="mailto:nguyentoai1907@gmail.com">nguyentoai1907@gmail.com</a>
                                </div>
                             </div>
                        </div>
                    </div>
